...
const LandingPage = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      desc: "Nearby verified users can respond to your emergency and earn ResQ Coins as rewards.",
  ...
  const testimonials = [
    { name: "Priya Sharma", role: "Patient", text: "ResQMed saved my father's life. The ambulance arrived in under 5 minutes!", avatar: "PS", color: "bg-blue-500" },
    { name: "Dr. Rahul Verma", role: "Cardiologist", text: "As a doctor, I recommend ResQMed to all my patients. It's a game-changer.", avatar: "RV", color: "bg-emerald-500" },
    { name: "Amit Kumar", role: "Community Helper", text: "I've earned 2000 ResQ Coins helping neighbors. It feels amazing to save lives!", avatar: "AK", color: "bg-violet-500" },
    ...
    <div className="min-h-screen overflow-x-hidden">
      ...
      <section className="relative min-h-screen mesh-gradient flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          ...
          <div className="absolute w-[400px] h-[400px] rounded-full border border-white/8" style={{ animation: 'spin-slow 15s linear infinite reverse' }} />
          <div className="absolute w-[200px] h-[200px] rounded-full border border-white/10 animate-spin-slow" style={{ animationDuration: '8s' }} />
        </div>
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
          ...
          <p className="text-xl text-white/70 max-w-2xl mx-auto mb-10 leading-relaxed animate-slide-up" style={{ animationDelay: '0.2s' }}>
            ResQMed connects you instantly to emergency services, nearby hospitals, and a community of helpers — all in one tap.
          </p>
      ...
      <section className="py-24 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 text-lg max-w-2xl mx-auto">From emergency response to routine appointments — ResQMed covers your entire healthcare journey.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-white/70 text-lg mb-8 leading-relaxed">
                Nearby ResQMed users get notified when someone needs emergency help. Respond, assist, and earn <strong className="text-yellow-400">ResQ Coins</strong> — redeemable for free appointments!
              </p>
      ...
      <section className="py-24 bg-gradient-to-b from-gray-900 to-black relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 text-center">
          ...
          <p className="text-white/60 text-lg max-w-2xl mx-auto mb-16">
            The future of healthcare is immersive. ResQMed brings cutting-edge AR and VR experiences to your medical journey.
          </p>
      ...
      <section className="py-24 bg-gradient-to-r from-blue-600 via-indigo-600 to-violet-600 animate-gradient relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-white/80 text-xl mb-10 max-w-2xl mx-auto">
            Join 89,000+ users who trust ResQMed for emergency care, appointments, and community health.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex items-center gap-3">
              ...
              <span className="text-white font-bold text-xl">ResQMed</span>
            </div>
            ...
            <p className="text-gray-500 text-sm">© 2024 ResQMed. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
