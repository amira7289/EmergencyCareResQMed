                    ...
                    <div className="space-y-4 pb-8">
                        {requests.length === 0 ? (
                            <div className="text-center py-16">
                                ...
                                <p className="text-gray-500">No pending help requests nearby. Check back soon.</p>
                            </div>
                        ) : (
                            requests.map(req => {
                                ...
                                return (
                                    <div
                                        key={req.id}
                                        className={`bg-white rounded-2xl p-5 border ${urg.border} shadow-sm transition-all duration-300 ${isAccepting ? 'scale-95 opacity-70' : 'hover:shadow-md'}`}
                                    >
                                        <div className="flex items-start justify-between mb-3">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="text-gray-500 text-sm">{req.condition}</div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <button
                                                ...
                                                className="px-4 py-2.5 bg-gray-100 text-gray-500 rounded-xl hover:bg-gray-200 transition flex items-center gap-1"
                                            >
                    ...
                    <div className="pb-8">
                        ...
                        <div className="space-y-3">
                            {LEADERBOARD.map((user) => (
                                <div key={user.rank} className={`bg-white rounded-xl p-4 border flex items-center gap-4 shadow-sm ${user.rank <= 3 ? 'border-yellow-200' : 'border-gray-100'}`}>
                                    <div className="text-2xl w-8 text-center">{user.badge}</div>
                                    <div className="flex-1">
                                        <div className="font-bold text-gray-900">{user.name}</div>
                                        <div className="text-gray-500 text-sm">{user.assists} assists</div>
                                    </div>
                                    <div className="text-right">
                ...
                {activeTab === 'redeem' && (
                    <div className="pb-8 space-y-4">
                        ...
                        {[
                            ...
                            <div key={i} className={`bg-white rounded-xl p-5 border shadow-sm flex items-center gap-4 ${item.available ? 'border-gray-100' : 'border-gray-100 opacity-60'}`}>
