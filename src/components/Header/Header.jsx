...
function Header() {
  ...
  // - On home: transparent if not scrolled, deep navy if scrolled
  // - Elsewhere: always deep navy
  ...
  return (
    <>
        ...
        <Container>
          <nav className="flex items-center justify-between h-16 px-4">
            ...
            <div className="hidden md:flex items-center gap-1">
              ...
              {/* Coins badge (only when logged in) */}
              {authStatus && (
                <button
            ...
            >
              <div className="flex flex-col items-center justify-center h-full space-y-8 px-8">
                ...
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="font-black text-3xl text-white">ResQMed</span>
                </div>
      ...
      {/* Spacer — Only on non-home pages to push content below the fixed header */}
